"""
'Almost' single-file implementation of MAA2C

implemented using a similar pipeline as MAPPO, IPPO
...
class MAA2C(BaseModel):
    def __init__(self, config: Config):
        super(MAA2C, self).__init__(config)
        self.config.model.batch_size = 1_000_000
        # akin to inf, use all the data we can get
    ...
    def train(self, env: AbstractEnv, curriculum_training: bool, writer: SummaryWriter, global_episode: int):
        ...
        for agent_id in range(num_CAV):
            ...
            for start in range(0, batch_size, minibatch_size):
                ...
                # Policy loss
                pg_loss = -torch.mean(b_logprobs[mb_inds] * mb_advantages)
