...
class IPPO_attention_patience_aggressive(BaseModel):
    def __init__(self, config: Config):
        super(IPPO_attention_patience_aggressive, self).__init__(config)
        ...
        num_training_steps=config.env.num_CAV * config.model.update_epochs * (config.model.train_episodes + 1)
