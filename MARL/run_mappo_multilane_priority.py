...
def train(args):
    ...
    env.config['LANE_CHANGE_COST'] = config.getint('ENV_CONFIG', 'LANE_CHANGE_COST')
    ...
    env_eval.config['PRIORITY_LANE_COST'] = config.getint('ENV_CONFIG', 'PRIORITY_LANE_COST')
    env_eval.config['LANE_CHANGE_COST'] = config.getint('ENV_CONFIG', 'LANE_CHANGE_COST')
