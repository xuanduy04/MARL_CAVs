...
class MergePriorityEnv(AbstractEnv):
    """
...
class MergePriorityEnvMARL(MergePriorityEnv):
    @classmethod
    def default_config(cls) -> dict:
        config = super().default_config()
        config.update({
...
register(
    id='merge-priority-v0',
    entry_point='highway_env.envs:MergePriorityEnv',
)

register(
    id='merge-priority-multi-agent-v0',
    entry_point='highway_env.envs:MergePriorityEnvMARL',
)
